import { Collection, Model, Database as Watermelondb } from '@nozbe/watermelondb';
import { Category } from './categories';
import { Transaction } from './transaction';

const collection: PropertyDecorator = function(target: any, key: string | symbol): PropertyDescriptor {
